...
var SystemLogLambdaClient_1 = require('../../src/version1/SystemLogLambdaClient');
...
suite('SystemLogLambdaClient', function () {
    ...
    var client = new SystemLogLambdaClient_1.SystemLogLambdaClient();
