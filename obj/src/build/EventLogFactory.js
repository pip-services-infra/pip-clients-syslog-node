...
class EventLogFactory extends pip_services_commons_node_2.Factory {
    constructor() {
        ...
        this.registerAsType(EventLogFactory.HttpClientV1Descriptor, EventLogHttpClientV1_1.EventLogHttpClientV1);
...
EventLogFactory.HttpClientV1Descriptor = new pip_services_commons_node_1.Descriptor('pip-services-eventlog', 'client', 'http', 'default', '1.0');
